...
export const RegisterFormComponent = () => (
  <ContainerComponent bgColor='#3e66ff'>
    <FormRegister action="">
      ...
      <InputComponent id="CPF" labelText="CPF" required type="number" variant='dark' labelColor='#e2eaff'/>
      <InputComponent id="RG" labelText="RG" required type="number" variant='dark' labelColor='#e2eaff'/>
      <InputComponent id="cellphone" labelText="Celular" type="number" variant='dark' labelColor='#e2eaff'/>
      <InputComponent id="email" labelText="Email" type="email" variant='dark' labelColor='#e2eaff'/>
